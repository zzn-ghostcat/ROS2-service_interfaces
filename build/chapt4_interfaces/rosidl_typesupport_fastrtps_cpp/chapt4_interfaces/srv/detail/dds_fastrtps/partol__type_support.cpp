...
#include "chapt4_interfaces/srv/detail/partol__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const chapt4_interfaces::srv::Partol_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  chapt4_interfaces::srv::Partol_Request & ros_message)
{
  // Member: target_x
  cdr >> ros_message.target_x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = chapt4_interfaces::srv::Partol_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const chapt4_interfaces::srv::Partol_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<chapt4_interfaces::srv::Partol_Request *>(
    untyped_ros_message);
...
{
  return &chapt4_interfaces::srv::typesupport_fastrtps_cpp::_Partol_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, chapt4_interfaces, srv, Partol_Request)() {
  return &chapt4_interfaces::srv::typesupport_fastrtps_cpp::_Partol_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_chapt4_interfaces
cdr_serialize(
  const chapt4_interfaces::srv::Partol_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: result
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  chapt4_interfaces::srv::Partol_Response & ros_message)
{
  // Member: result
  cdr >> ros_message.result;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = chapt4_interfaces::srv::Partol_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const chapt4_interfaces::srv::Partol_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<chapt4_interfaces::srv::Partol_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &chapt4_interfaces::srv::typesupport_fastrtps_cpp::_Partol_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, chapt4_interfaces, srv, Partol_Response)() {
  return &chapt4_interfaces::srv::typesupport_fastrtps_cpp::_Partol_Response__handle;
}
...
{
  return &chapt4_interfaces::srv::typesupport_fastrtps_cpp::_Partol__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, chapt4_interfaces, srv, Partol)() {
  return &chapt4_interfaces::srv::typesupport_fastrtps_cpp::_Partol__handle;
}
