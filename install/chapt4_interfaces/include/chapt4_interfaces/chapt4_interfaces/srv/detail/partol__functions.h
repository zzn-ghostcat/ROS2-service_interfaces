...
#ifndef CHAPT4_INTERFACES__SRV__DETAIL__PARTOL__FUNCTIONS_H_
#define CHAPT4_INTERFACES__SRV__DETAIL__PARTOL__FUNCTIONS_H_
 ...
 * calls
 * chapt4_interfaces__srv__Partol_Request__init().
...
/**
 * It calls
 * chapt4_interfaces__srv__Partol_Request__fini()
 ...
 * chapt4_interfaces__srv__Partol_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * chapt4_interfaces__srv__Partol_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * chapt4_interfaces__srv__Partol_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_chapt4_interfaces
...
/**
 * It calls
 * chapt4_interfaces__srv__Partol_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_chapt4_interfaces
...
/**
 * It allocates the memory for the array and calls
 * chapt4_interfaces__srv__Partol_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_chapt4_interfaces
...
/**
 * It calls
 * chapt4_interfaces__srv__Partol_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // CHAPT4_INTERFACES__SRV__DETAIL__PARTOL__FUNCTIONS_H_
