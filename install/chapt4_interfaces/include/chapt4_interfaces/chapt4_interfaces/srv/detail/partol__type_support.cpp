...
{
  new (message_memory) chapt4_interfaces::srv::Partol_Request(_init);
}

void Partol_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<chapt4_interfaces::srv::Partol_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Partol_Request_message_member_array[2] = {
  {
    ...
    offsetof(chapt4_interfaces::srv::Partol_Request, target_x),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(chapt4_interfaces::srv::Partol_Request, target_y),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Partol_Request_message_members = {
  ...
  2,  // number of fields
  sizeof(chapt4_interfaces::srv::Partol_Request),
...
{
  return &::chapt4_interfaces::srv::rosidl_typesupport_introspection_cpp::Partol_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, chapt4_interfaces, srv, Partol_Request)() {
  return &::chapt4_interfaces::srv::rosidl_typesupport_introspection_cpp::Partol_Request_message_type_support_handle;
}
...
void Partol_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) chapt4_interfaces::srv::Partol_Response(_init);
}

void Partol_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<chapt4_interfaces::srv::Partol_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Partol_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(chapt4_interfaces::srv::Partol_Response, result),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Partol_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(chapt4_interfaces::srv::Partol_Response),
...
{
  return &::chapt4_interfaces::srv::rosidl_typesupport_introspection_cpp::Partol_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, chapt4_interfaces, srv, Partol_Response)() {
  return &::chapt4_interfaces::srv::rosidl_typesupport_introspection_cpp::Partol_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers Partol_service_members = {
  ...
  // see get_service_type_support_handle<chapt4_interfaces::srv::Partol>()
...
get_service_type_support_handle<chapt4_interfaces::srv::Partol>()
{
  ...
  auto service_type_support =
    &::chapt4_interfaces::srv::rosidl_typesupport_introspection_cpp::Partol_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, chapt4_interfaces, srv, Partol)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<chapt4_interfaces::srv::Partol>();
}
