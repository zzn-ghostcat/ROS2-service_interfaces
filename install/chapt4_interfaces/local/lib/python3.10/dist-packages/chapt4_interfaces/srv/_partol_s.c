...
bool chapt4_interfaces__srv__partol__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("chapt4_interfaces.srv._partol.Partol_Request", full_classname_dest, 44) == 0);
  }
  chapt4_interfaces__srv__Partol_Request * ros_message = _ros_message;
  {  // target_x
...
PyObject * chapt4_interfaces__srv__partol__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("chapt4_interfaces.srv._partol");
...
ROSIDL_GENERATOR_C_EXPORT
bool chapt4_interfaces__srv__partol__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("chapt4_interfaces.srv._partol.Partol_Response", full_classname_dest, 45) == 0);
  }
  chapt4_interfaces__srv__Partol_Response * ros_message = _ros_message;
  {  // result
